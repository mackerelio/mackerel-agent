...
func (g *GCEGenerator) SuggestCustomIdentifier() (string, error) {
	...
	err := retry.Retry(3, 2*time.Second, func() error {
		cl := httpCli()
		// $ curl -q http://metadata.google.internal/computeMetadata/v1/instance/id -H "Metadata-Flavor: Google"
		// 8618997027285493035 # This is a unique, numerical ID that is generated by Compute Engine.
